package com.example.socialmap.Services
...
class FirebaseNotificationService : FirebaseMessagingService() {
    ...
    private fun createNormalNotification(
        ...
        builder.setContentTitle(title)
            ...
            .setAutoCancel(true)
            .setColor(ResourcesCompat.getColor(resources, R.color.transparent, null))
            .setSound(uri)
    ...
    private fun createOreoNotification(
        ...
        intent.putExtra("hisId", hisId.toString())
        intent.putExtra("hisName", title.toString())
        intent.putExtra("hisImage", hisImage.toString())
        intent.putExtra("chatId", chatId.toString())
        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP)
